        ...
        children: [
          Row(
            ...
            children: [
              ...
              FilledButton.icon(
                onPressed: () => showDialog(context: context, builder: (_) => const AdminAddEventDialog()),
    ...
    return DataRow(
      cells: [
          ...
          children: [
            ClipRRect(
              ...
              child: Container(
                ...
                child: Icon(Icons.event_rounded, color: Colors.white.withValues(alpha: 0.6), size: 22),
              ),
            ),
            ...
            Column(
              ...
              children: [
                ...
                Text(e.location, style: const TextStyle(color: AppTheme.textSecondary, fontSize: 12)),
              ],
            ),
          ],
        )),
        DataCell(Container(
          ...
          child: Text(e.category, style: const TextStyle(color: AppTheme.primaryRed, fontSize: 12)),
        )),
