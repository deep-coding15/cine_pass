...
--
-- Class Cinema as table cine_pass_cinema
--
...
--
-- Class Evenement as table cine_pass_evenement
--
...
--
-- Class Film as table cine_pass_film
--
...
--
-- Class Salle as table cine_pass_salle
--
...
--
-- Class Seance as table cine_pass_seance
--
CREATE TABLE "cine_pass_seance" (
    ...
    "format" text NOT NULL DEFAULT 'VF'::text,
    "type" text NOT NULL DEFAULT '2D'::text,
    "prixBase" double precision NOT NULL,
    "availableOptions" json
);

--
-- Class Siege as table cine_pass_siege
--
...
--
-- Class PhoneAuthCode as table phone_auth_code
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('cine_pass', '20260311002511610', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260311002511610', "timestamp" = now();
